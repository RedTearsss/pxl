...
uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Classes, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, PXL.Types,
  PXL.Timing, PXL.ImageFormats, PXL.Devices, PXL.Canvas, PXL.SwapChains, PXL.Surfaces, PXL.Images, PXL.Fonts,
  PXL.Providers, PXL.Palettes;
...
uses
  PXL.Classes, PXL.ImageFormats.Auto, PXL.Providers.Auto;
