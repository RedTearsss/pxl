...
uses
  ...
  Vcl.Forms, Vcl.Dialogs, PXL.TypeDef, PXL.Types, PXL.Timing, PXL.ImageFormats, PXL.Devices, PXL.Textures, PXL.Canvas,
  PXL.SwapChains, PXL.Images, PXL.Fonts, PXL.Providers;
